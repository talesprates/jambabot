...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('protractor', 'A grunt task to run protractor.', function() {
    ...
    var protractorMainPath = require.resolve('../../node_modules/protractor/lib/protractor.js');
    var protractorBinPath = path.resolve(protractorMainPath, '../../node_modules/bin/protractor');
    var webdriverManagerPath = path.resolve(protractorMainPath, '../../node_modules/bin/webdriver-manager');
